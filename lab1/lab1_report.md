...
**Вывод**
На начальном этапе доступ к файлам в бакете был успешно получен. После изменения роли service account ожидалось ограничение доступа, но этого не случилось и в процессе анализа было обнаружено, что причиной являлся публичный доступ к бакету через группу allUsers.
После отключения публичного доступа операции с файлами стали недоступны, что подтвердило корректность настройки ролей IAM и механизмов контроля доступа.
